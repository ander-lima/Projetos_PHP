...
<body>
    ...
    <main>
        ...
        <?php 
            ...
            echo "Seus R$" . number_format($preco, 2) . " valem US$" . number_format($convertido, 2) . " em dólar";
        ?>
        -->
        ...
        //Versão Professor
            ...
            echo "Seus R$" . numfmt_format_currency($padrao, $preco, "BRL") . " valem US\$" . numfmt_format_currency($padrao, $preco, "USD") . " em dólar";
        ?>
